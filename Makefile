...
# Clean build files
clean:
	del *.o $(MAIN_EXE) $(TEST_EXE) $(TEST_PARSER_EXE) $(TEST_SEMANTIC_EXE) $(TEST_CODEGEN_EXE) $(TEST_WHILE_EXE) $(TEST_BREAK_CONTINUE_EXE) $(TEST_FOR_EXE) $(TEST_ARRAYS_EXE) 2>nul || true
